...
function FullAppStackNavigator() {
  return (
    ...
    >
      <FullAppStack.Screen name="LoginScreen" component={LoginScreen} />
      <FullAppStack.Screen
        name="RegistrationScreen"
        component={RegistrationScreen}
      />
      <FullAppStack.Screen name="TermsScreen" component={TermsScreen} />
      <FullAppStack.Screen name="ContactScreen" component={ContactScreen} />
      <FullAppStack.Screen name="Drawer" component={DrawerNavigator} />
    </FullAppStack.Navigator>
  );
}
