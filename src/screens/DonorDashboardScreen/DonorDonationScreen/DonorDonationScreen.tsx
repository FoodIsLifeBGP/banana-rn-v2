...
export default function DonorDonationScreen(props) {
  ...
  const submitDonation = async () => {
    ...
    switch (statusCode) {
    case 201: Alert.alert('Donation created!'); getDonationsOrClaims(); props.navigation.navigate('LoginSuccessScreen'); return;
    case 202: Alert.alert('Donation updated!'); getDonationsOrClaims(); props.navigation.navigate('LoginSuccessScreen'); return;
    case (400 || 406): Alert.alert('Bad data - sorry, please try again!'); return;
    case (401 || 403): Alert.alert('Authentication error - please log in again.'); logOut(); props.navigation.navigate('LoginScreen'); return;
